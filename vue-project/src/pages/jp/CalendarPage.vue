      ...
      <div class="schedule-list modern-style">
        ...
        >
          ...
          <div class="schedule-events">
            ...
            >
              <span class="event-tag">{{  translateType(event.type)  }}</span>
...
function translateType(type) {
  if (type.includes('보강')) return '補講';
  if (type.includes('휴강')) return '休講';
  if (type === '공휴일') return '祝日';
  if (type === '학과 공지') return '学科日程';
  return ; // 나머지는 그대로
}
